export interface ColombiaDepto {
  name: string;
  cities: string[];
}

export const COLOMBIA_GEO: ColombiaDepto[] = [
  {
    name: 'Amazonas',
  ...
  },
  {
    ...
    cities: [
      ...
      'Heliconia', 'Hispania', 'Itagüí', 'Ituango', 'Jericó', 'La Ceja',
      'La Estrella', 'La Pintada', 'La Unión', 'Liborina', 'Maceo', 'Marinilla',
      'Medellín', 'Montebello', 'Murindó', 'Mutatá', 'Nariño', 'Nechí', 'Necoclí',
      'Olaya', 'Peque', 'Puerto Berrío', 'Puerto Nare', 'Puerto Triunfo',
      'Remedios', 'Retiro', 'Rionegro', 'Sabaneta', 'Salgar', 'San Andrés de Cuerquia',
  ...
  },
  {
    name: 'Boyacá',
    cities: [
      'Tunja', 'Aquitania', 'Arcabuco', 'Belén', 'Berbeo', 'Betéitiva', 'Boavita',
      ...
      'Santana', 'Sativanorte', 'Sativasur', 'Siachoque', 'Soatá', 'Socha',
      ...
      'Tutazá', 'Umbita', 'Úmbita', 'Ventaquemada', 'Villa de Leyva', 'Viracachá',
      'Zetaquira',
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      'Florencia', 'Guachené', 'Guapí', 'Inzá', 'Jambaló', 'La Sierra', 'La Vega',
      'López de Micay', 'Mercaderes', 'Miranda', 'Morales', 'Padilla', 'Páez',
      'Patía', 'Piamonte', 'Piendamó', 'Puerto Tejada', 'Puracé', 'Rosas',
      'San Sebastián', 'Santa Rosa', 'Santander de Quilichao', 'Silvia', 'Sotara',
  ...
  },
  {
    ...
    cities: [
      ...
      'Río de Oro', 'Robles / La Paz', 'San Alberto', 'San Diego', 'San Martín',
      'Tamalameque',
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      'El Peñón', 'El Rosal', 'Fomeque', 'Fosca', 'Funza', 'Fúquene', 'Fusagasugá',
      ...
      'La Palma', 'La Peña', 'La Vega', 'Lenguazaque', 'Machetá', 'Madrid',
      'Manta', 'Medina', 'Mosquera', 'Nariño', 'Nemocón', 'Nilo', 'Nimaima',
      'Nocaima', 'Pacho', 'Paime', 'Pandi', 'Paratebueno', 'Pasca', 'Puerto Salgar',
      'Pulí', 'Quebradanegra', 'Quetame', 'Quipile', 'Ricaurte', 'San Antonio del Tequendama',
      'San Bernardo', 'San Cayetano', 'San Francisco', 'San Juan de Rioseco',
      'Sasaima', 'Sesquilé', 'Sibaté', 'Silvania', 'Simijaca', 'Soacha',
      'Sopó', 'Subachoque', 'Suesca', 'Supatá', 'Susa', 'Sutatausa', 'Tabio',
      'Tausa', 'Tena', 'Tenjo', 'Tibacuy', 'Tibiritá', 'Tocaima', 'Tocancipá',
  ...
  },
  {
    ...
    cities: [
      ...
      'Buesaco', 'Colón', 'Consacá', 'Contadero', 'Córdoba', 'Cuaspud', 'Cumbal',
      'Cumbitara', 'Chachagüí', 'El Charco', 'El Peñol', 'El Rosario', 'El Tablón de Gómez',
      ...
      'Puerres', 'Pupiales', 'Ricaurte', 'Roberto Payán', 'Samaniego', 'Sandoná',
      'San Bernardo', 'San Lorenzo', 'San Pablo', 'San Pedro de Cartago', 'Santa Bárbara',
  ...
  },
  {
    ...
    cities: [
      ...
      'Salazar', 'San Calixto', 'San Cayetano', 'San José de Cúcuta', 'Santiago',
  ...
  },
  {
    ...
    cities: ['San Andrés', 'Providencia y Santa Catalina'],
  },
  {
    name: 'Santander',
    cities: [
      ...
      'Chipatá', 'Cimitarra', 'Concepción', 'Confines', 'Contratación', 'Coromoro',
  ...
  },
  {
    ...
    cities: [
      ...
      'Santiago de Tolú', 'Sincé', 'Sucre', 'Toluviejo',
    ],
  },
  {
    name: 'Tolima',
  ...
  },
  {
    ...
    cities: [
      ...
      'Buenaventura', 'Buga', 'Bugalagrande', 'Caicedonia', 'Calima', 'Candelaria',
      'Cartago', 'Dagua', 'El Águila', 'El Cairo', 'El Cerrito', 'El Dovio',
      'El Limonar', 'Florida', 'Ginebra', 'Guacarí', 'Jamundí', 'La Cumbre',
  ...
  {
    name: 'Vaupés',
    cities: ['Mitú', 'Carurú', 'Pacoa', 'Papunahua', 'Taraira', 'Yavaraté'],
  },
  {
    name: 'Vichada',
...
export const COLOMBIA_DEPTOS: string[] = COLOMBIA_GEO.map((d) => d.name);

export function getCitiesForDepto(name: string): string[] {
  return COLOMBIA_GEO.find((d) => d.name === name)?.cities ?? [];
}
