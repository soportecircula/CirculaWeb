...
export const changeThemeColor = createAction('[Layout] Set Theme Color', props<{ themecolor: string }>());
...
export const changeBackgrounImage = createAction('[Layout] Set backgroundImage', props<{ backgroundImage: string }>());
